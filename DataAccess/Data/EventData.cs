...
namespace DataAccess.Data
{
    public class EventData : IEventData
    {
        ...
        public async Task<IEnumerable<EventModel>> GetEventForDay(DateTime Date, int Id)
        {
        ...
        public async Task<IEnumerable<EventModel>> GetEventForMonth(DateTime Date, int Id)
        {
